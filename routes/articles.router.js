...
const { getArticle, 
        ...
        getAllArticles, 
        postArticle,
        deleteArticle, } = require('../mvc/controllers/articles.controller.js')
...
articlesRouter.route('/:article_id').get(getArticle).patch(patchVotes).delete(deleteArticle).all(handle405s);
